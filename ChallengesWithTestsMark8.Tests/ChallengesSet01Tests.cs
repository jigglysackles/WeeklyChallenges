...
public class ChallengesSet01Tests
{
    ...
    {
        // Arrange
        var challenger = new ChallengesSet01();

        // Act
        var actual = challenger.AreTwoNumbersTheSame(number1, number2);
    ...
    public void Add(int addend1, int addend2, int expectedSum)
    {
        ...
        // Act
        var actual = challenger.Add(addend1, addend2);
    ...
    public void GetSmallestNumber(int number1, int number2, int expected)
    {
        ...
        // Act
        var actual = challenger.GetSmallestNumber(number1, number2);
    ...
    public void Multiply(long factor1, long factor2, long product)
    {
        ...
        // Act
        var actual = challenger.Multiply(factor1, factor2);
    ...
    public void GetGreeting(string personName, string expectedGreeting)
    {
        ...
        // Act
        var actual = challenger.GetGreeting(personName);
