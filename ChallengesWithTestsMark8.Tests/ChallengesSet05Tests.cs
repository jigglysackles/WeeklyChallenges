...
public class ChallengesSet05Tests
{
    ...
    {
        // Arrange
        var challenger = new ChallengesSet05();

        // Act
        var actual = challenger.GetNextNumberDivisibleByN(startNumber, n);
    ...
    public void ChangeNamesOfBusinessesWithNoRevenueTo_CLOSED(string[] names, double[] revenues)
    {
        // Arrange
        var challenger = new ChallengesSet05();
        var businesses = new Business[names.Length];
    ...
    public void IsAscendingOrder(int[] nums, bool expected)
    {
        ...
        // Act
        var actual = challenger.IsAscendingOrder(nums);
    ...
    public void SumElementsThaFollowAnEven(int[] numbers, int expected)
    {
        ...
        // Act
        var actual = challenger.SumElementsThatFollowAnEven(numbers);
    ...
    [InlineData(new[] { "This", "is", "only", "a", "test" }, "This is only a test.")]
    ...
    public void TurnWordsIntoSentence(string[] words, string expected)
    {
        ...
        // Act
        var actual = challenger.TurnWordsIntoSentence(words);
    ...
    public void GetEveryFourthElement(double[] numbers, double[] expected)
    {
        ...
        // Act
        var actual = challenger.GetEveryFourthElement(numbersAsList);
    ...
    public void TwoDifferentElementsInArrayCanSumToTargetNumber(int[] numbers, int targetNumber, bool expected)
    {
        ...
        // Act
        var actual = challenger.TwoDifferentElementsInArrayCanSumToTargetNumber(numbers, targetNumber);
