...
{
    [Theory]
    [InlineData(new[] { 2, 6, 8, 3, 1, 3 }, 9)]
    [InlineData(new[] { 4, 6, 10 }, 20)]
    [InlineData(new[] { 3, 1, 3 }, -7)]
    ...
    {
        // Arrange
        var challenger = new ChallengesSet04();

        // Act
        var actual = challenger.AddEvenSubtractOdd(numbers);
    ...
    public void GetLengthOfShortestString(string string1, string string2, string string3, string string4, int expected)
    {
        ...
        // Act
        var actual = challenger.GetLengthOfShortestString(string1, string2, string3, string4);
    ...
    public void GetSmallestNumber(int num1, int num2, int num3, int num4, int expected)
    {
        ...
        // Act
        var actual = challenger.GetSmallestNumber(num1, num2, num3, num4);
    ...
    public void ChangeBusinessNameTo_TrueCoders(string originalBusinessName)
    {
        // Arrange
        var challenger = new ChallengesSet04();
        var business = new Business { Name = originalBusinessName };
    ...
    public void CouldFormTriangle(int sideLength1, int sideLength2, int sideLength3, bool expected)
    {
        ...
        // Act
        var actual = challenger.CouldFormTriangle(sideLength1, sideLength2, sideLength3);
    ...
    public void IsStringANumber(string word, bool expected)
    {
        ...
        // Act
        var actual = challenger.IsStringANumber(word);
    ...
    [Theory]
    [InlineData(new[] { "test", null, "test" }, false)]
    [InlineData(new[] { "test", null, "test", null }, false)]
    [InlineData(new[] { null, "test" }, false)]
    [InlineData(new[] { null, "test", "test" }, false)]
    [InlineData(new[] { "test", "test", "test" }, false)]
    [InlineData(new[] { "test", "test", null }, false)]
    ...
    [InlineData(new[] { null, "test", "test", null, null }, true)]
    [InlineData(new[] { null, null, "test", null, "test" }, true)]
    [InlineData(new[] { null, "test", null, "test", null }, true)]
    ...
    public void MajorityOfElementsInArrayAreNull(object[] objects, bool expected)
    {
        ...
        // Act
        var actual = challenger.MajorityOfElementsInArrayAreNull(objects);
    ...
    [InlineData(new[] { -1, -2, -3, -4, -5 }, -3)]
    [InlineData(new[] { 1, 2, 2, 3, 4 }, 2.6666666666)]
    [InlineData(new[] { 1, -2, -2, 3, -4 }, -2.6666666666)]
    [InlineData(new[] { 1, -2, 2, 3, -4 }, -1.3333333333)]
    ...
    public void AverageEvens(int[] numbers, double expected)
    {
        ...
        // Act
        var actual = challenger.AverageEvens(numbers);
    ...
    public void Factorial(int number, int expected)
    {
        ...
        // Act
        var actual = challenger.Factorial(number);
